...
`,gt=(t,e)=>t.reduce((t,i)=>(i.defineId?t[i.defineId]=i:i.promise.then(t=>{void 0===e.registry.get(i.name)&&e.registry.define(i.name,t)}),t),{}),ft=t=>({name:t,promise:customElements.whenDefined(t).then(()=>customElements.get(t))}),mt=(t,e,i={},s={})=>{const r=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});return r.detail=i,t.dispatchEvent(r),r},bt=[[{label:"Shorten Cards",key:"shorten_cards"}],[{label:"Persist Features",key:"persist_features"},{label:"Show Brightness",key:"brightness"}],[{label:"Show Color Temp",key:"color_temp"},{label:"Color Temp in Kelvin",key:"color_temp_in_kelvin"}],[{label:"Show White Channel",key:"white_value"}],[{label:"Show Warm White",key:"warm_white_value"}],[{label:"Show Speed",key:"speed"},{label:"Show Intensity",key:"intensity"}],[{label:"Show Color Picker",key:"color_picker"},{label:"Show Effects List",key:"effects_list"}],[{label:"Full Width Sliders",key:"full_width_sliders"},{label:"Show Slider Percent",key:"show_slider_percent"}],[{label:"Show Brightness %",key:"show_brightness_percent"},{label:"Show Color Temp %",key:"show_color_temp_percent"}],[{label:"Hide Header",key:"hide_header"},{label:"Show Header Icon",key:"show_header_icon"},{label:"Child Card",key:"child_card"}],[{label:"Force Features",key:"force_features"}],[{label:"Consolidate Entities",key:"consolidate_entities"}],[{label:"Fixed White",key:"fixed_white"}]],yt=[{name:"brightness_icon",label:"Brightness Icon"},{name:"white_icon",label:"White Icon"},{name:"warm_white_icon",label:"Warm White Icon"},{name:"temperature_icon",label:"Temperature Icon"}];class vt extends(dt(ct)){static get elementDefinitions(){return gt([ft("ha-checkbox"),ft("ha-formfield"),ft("ha-form-string"),ft("ha-select"),ft("mwc-list-item")],vt)}static get styles(){return pt}static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config={...ut,...t}}firstUpdated(){this._firstRendered=!0}get entityOptions(){return Object.keys(this.hass.states).filter(t=>["switch","light","group"].includes(t.split(".")[0])).sort()}render(){if(!this.hass||!this._config)return B``;let{header:t}=this._config;if(!t&&this._config.entity){const e=this._config.entity.split(".")[1]||"";e&&(t=e.charAt(0).toUpperCase()+e.slice(1))}const e=this.entityOptions.map(t=>B`<mwc-list-item value="${t}" ?selected=${t===this._config.entity}>${t}</mwc-list-item>`);return B`
      <div class="card-config">
        ...
        <div class="entities">
          ${this._renderIconFields(yt.slice(0,2))}
        </div>
        <div class="entities">
          ${this._renderIconFields(yt.slice(2))}
          <ha-form-string
    ...
    `}_renderIconFields(t){return t.map(({name:t,label:e})=>B`
      <ha-form-string
    ...
    `}_createColorDots(t){const e=t.attributes.hs_color||[0,0],i=this.config.preset_colors||xt;return B`
    ...
    `}_setSaturation(t,e){const i=parseInt(t.target.value,10);if(isNaN(i))return;const s=e.attributes.hs_color||[0,0];Math.round(s[1])!==i&&this._callService({hs_color:[s[0],i]},e)}_showPercent(t,e,i,s){if("brightness"===s&&void 0!==this.config.show_brightness_percent){if(!this.config.show_brightness_percent)return B``}else if("color_temp"===s&&void 0!==this.config.show_color_temp_percent){if(!this.config.show_color_temp_percent)return B``}else if("color_temp"===s&&this.config.color_temp_in_kelvin);else if(!this.config.show_slider_percent)return B``;if("color_temp"===s&&this.config.color_temp_in_kelvin)return B`<div class="percent-slider">${t}K</div>`;const r=i!==e?Math.round(100*(t-e)/(i-e)):0;return B`<div class="percent-slider">${isNaN(r)?0:r}%</div>`}_getColorTempRange(t){const e=t.attributes,i=void 0!==e.min_color_temp_kelvin;let s,r,o,n,a;if(i){if(s=e.color_temp_kelvin,r=e.min_color_temp_kelvin,o=e.max_color_temp_kelvin,!r||!o)return null;n=Math.round($t/o),a=Math.round($t/r)}else{if(n=e.min_mireds,a=e.max_mireds,!n||!a)return null;s=e.color_temp?Math.round($t/e.color_temp):null,r=Math.round($t/a),o=Math.round($t/n)}return{usesKelvin:i,kelvin:"number"==typeof s&&Number.isFinite(s)&&s>0?s:null,minK:r,maxK:o,minMired:n,maxMired:a}}_createColorTemperature(t){if(!1===this.config.color_temp)return B``;if(!this.shouldShowFeature("colorTemp",t))return B``;const e=this._getColorTempRange(t);if(!e)return B``;const{usesKelvin:i,kelvin:s,minK:r,maxK:o,minMired:n,maxMired:a}=e;let l,c,h,d,_;if(this.config.color_temp_in_kelvin)l=r,c=o,h=s??Math.round((r+o)/2),d="light-entity-card-color_temp light-entity-card-color_temp--kelvin",_=e=>this._setColorTemp(e,t,i,!0);else{const e=a-n,r=s?Math.round($t/s):null;l=0,c=100,h=e>0&&null!==r?Math.round((r-n)/e*100):50,d="light-entity-card-color_temp",_=e=>this._setColorTemp(e,t,i,!1,n,a)}const u=`${t.entity_id}_color_temp`,p=this._liveValues?.[u]??h;return B`
      <div class="control light-entity-card-center">
        ...
        <ha-slider
          ...
          max="${c}"
          .value=${h}
          @input="${t=>{this._liveValues={...this._liveValues,[u]:parseInt(t.target.value,10)}}}"
          @change="${t=>{this._liveValues={...this._liveValues,[u]:void 0},_(t)}}"
          aria-label="Color temperature"
        ></ha-slider>
        ${this._showPercent(p,l,c,"color_temp")}
      </div>
