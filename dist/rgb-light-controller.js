        ...
        <div class='overall-config'>
          ...
          <div class='checkbox-options'>
            <ha-formfield label="White Mode">
              ...
              >
                <option value="auto" ?selected=${"auto"===(this._config.white_mode||"auto")}>Auto</option>
                <option value="range" ?selected=${"range"===this._config.white_mode}>Range</option>
                <option value="fixed" ?selected=${"fixed"===this._config.white_mode}>Fixed</option>
              </select>
            </ha-formfield>
          </div>
      </div>
